...
\acrshort{fim} allows users to authenticate on multiple SPs using the same credentials, which 
...
The \acrshort{idp} then issues cryptographically signed SAML assertions that SPs accept 
as proof of identity.
This architecture is widely deployed in higher education and research federation such as DFN-AAI~\cite{DFNAAI}, 
where a single \acrshort{idp} serves dozens of SPs simultaneously.
