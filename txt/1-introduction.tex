...
\begin{itemize}
    ...
    \item Chapter~\ref{ch:system-design} presents the architecture of the proposed system, and 
    \item Chapter~\ref{ch:implementation} describes its implementation devided in layers. 
    \item Chapter~\ref{ch:evaluation} evaluates the system with respect to the three research questions above. 
    \item Chapter~\ref{ch:discussion} discusses the interpretation of the results and the limitation of the study. 
    \item Chapter~\ref{ch:conclusion} summarises the findings and outlines directions for future work.
\end{itemize}
