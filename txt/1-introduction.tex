...
\begin{itemize}
    ...
    \item Chapter 7 discusses the interpretation of the results and the limitation of the study. 
    \item Chapter 8 summarises the findings and outlines directions for future work.
\end{itemize}
