...
The internal measurements via \textit{executionTimeMs}, resulted in a total latency of \~320ms, which 
corresponds to the 0,3\% median of the login duration. 
Previous individual values of around 2,3 ms were cold-start values (JIT, class loading). 
